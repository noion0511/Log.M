...
class ListMemoEditActivity : AppCompatActivity() {
    ...
    private val memoViewModel: ListMemoViewModel by viewModels()
    ...
    override fun onSaveInstanceState(outState: Bundle) {
        ...
        val itemList = listAdapter.getItems().toTypedArray()
        outState.putSerializable("listItems", itemList)
    }

    override fun onRestoreInstanceState(savedInstanceState: Bundle) {
        super.onRestoreInstanceState(savedInstanceState)
        val itemList = savedInstanceState.getParcelableArray("listItems")?.toList() as List<ListItem>
